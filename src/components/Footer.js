...
export function Footer(){
    ...
    return(
        <Container className="p-0 pwa-mode">
          <Nav variant="pills" className="justify-content-center align-items-center fixed-bottom bg-primary">
            <Nav.Item>
              <Nav.Link href="/" className="text-danger"><img src={logo} height={45} width={45} alt="logo" className="rounded-circle"></img></Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link href="/cart" className="text-danger">                                
            ...
            <Nav.Item>
            <Nav.Link href="/custom" className="text-danger">
