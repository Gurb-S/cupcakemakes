...
export function BodyGradient() {
    ...
    return(
        <div className={isInWebAppiOS || isInWebAppChrome ? "p-5 mt-5 text-info main-gradient" : "p-5 text-info main-gradient large"}>
            <p className={isInWebAppiOS || isInWebAppChrome ? "mt-5" : 'text-center large-screen'}>Welcome to Cupcake Makes, we're a business based in Plumas Lake, CA</p>
            <p className="text-center large-text">We offer both ordering predesigned cupcakes and placing custom orders!</p>
