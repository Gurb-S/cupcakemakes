                ...
                <Container>
                    ...
                    <Row>
                        <Col className="d-flex align-items-center ms-3">
                            <a href="/checkout" className="me-3 text-dark">
                            ...
                            <button className='btn btn-body d-lg-none' type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">                                
